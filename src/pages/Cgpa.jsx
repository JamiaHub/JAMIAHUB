      ...
      <div className="relative z-10 container mx-auto px-4 py-12">
        <div className="text-center mb-12 animate-slide-up">
          ...
          <p className="text-gray-300 text-lg">
            Calculate your SPI & CPI with ease
          </p>
        </div>
              ...
              <div className="lg:col-span-2">
                ...
                <div className="mt-8 bg-gray-900/60 backdrop-blur-xl rounded-2xl p-6 border border-gray-700/50">
                  ...
                  <ul className="text-gray-400 space-y-2 text-sm">
                    <li>
                      • <strong>SPI</strong> = Σ(Credits × Grade Points) ÷ Σ
                      Credits
                    </li>
                    <li>
                      • Each grade has a point value (O=10, A+=9, A=8, etc.)
                    </li>
                    <li>
        ...
        {activeTab === "cpi" && (
          <div className="max-w-4xl mx-auto animate-card-appear">
            <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 backdrop-blur-xl rounded-3xl shadow-3xl border border-purple-500/20 p-8">
              <div className="space-y-4 mb-6">
                <h2 className="text-2xl font-bold text-purple-300 mb-4">
                  Enter Semester Performance Index (SPI)
                </h2>
                      ...
                      <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            ...
                            value={semester.spi}
                            onChange={(e) =>
                              updateSemester(index, "spi", e.target.value)
                            }
                            className="w-full bg-gray-900/50 border border-gray-600 rounded-lg px-4 py-2 text-white placeholder-gray-500 focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all"
                          />
                        </div>
            ...
            <div className="mt-8 bg-gray-900/60 backdrop-blur-xl rounded-2xl p-6 border border-gray-700/50">
              ...
              <ul className="text-gray-400 space-y-2 text-sm">
                <li>
                  • <strong>Year Weights</strong>: Year 1 (25%), Year 2 (50%),
                  Year 3 (75%), Year 4 (100%)
                </li>
                <li>
                  • <strong>CPI</strong>: Weighted average of yearly SPIs based
                  on year weights
                </li>
                <li>
                  • <strong>Percentage</strong>: Y% = 10 × CPI
                </li>
                <li>
                  • <strong>Division</strong>: Distinction (CPI ≥ 8.5), I
                  Division (6.5-8.5), II Division (≤ 6.4)
                </li>
              </ul>
            </div>
          </div>
